...
// ============================================================================
// Global Instance (for C-style API compatibility layer)
// ============================================================================
static ST7789Display* g_display_instance = nullptr;
...
/**
 * Default constructor - uses default hardware configuration
 */
