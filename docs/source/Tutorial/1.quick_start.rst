...
你收到产品之后可以使用附带的typec数据线通电插入esp32c6模块的typec口,正常情况下产品会自动亮起并显示下面所示的Onboard Info界面
...
2.Follow these steps to upload the firmware:
    ...
    C.Select the COM port corresponding to ESP32-C6 from the port selection dropdown menu (Use windows device manager to view)
